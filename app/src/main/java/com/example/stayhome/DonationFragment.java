...
public class DonationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        categoryRecyclerView = view.findViewById(R.id.donation_heading_recycler_view);
        ...
        categoryItemModelList.add(new CategoryItemModel(R.drawable.logo_ek_takar_ahar,"১টাকায় আহার", "t.ly/Lgr0g"));
        categoryItemModelList.add(new CategoryItemModel(R.drawable.logo_ovijatrik,"অভিযাত্রিক", "t.ly/eZwzr"));
        ...
        categoryRecyclerView.addItemDecoration(new DonationFragment.SpacesItemDecoration(7));
